...
const SMS_TEMPLATES = {
  1: "【北京觅理律师事务所】{company_name} 您好，企业风控不仅在于诉讼胜诉，更重在源头规避法律风险，减少纠纷损失与合规处罚。适值本所公益咨询周，我们梳理公司治理、合同履约、财税合规、劳动用工、知产保护五维高频风险，整理《企业法律健康体检清单》供自查。如需清单或有诉讼需求可添加微信（同手机号）咨询。退订请回复T",
  2: "",
  3: "",
  4: "",
  5: ""
