        ...
        <div class="trace-card add-card">
          ...
          <el-form :model="traceForm" label-width="80px" label-position="left" class="trace-form">
            <el-form-item label="跟进方式">
              <el-select v-model="traceForm.trace_type" @change="updateTraceType" placeholder="请选择跟进方式"
                         style="width: 100%;">
...
企业的风控，从来不是赢得一场官司，而是从源头规避潜在的法律风险，避免纠纷、损失与合规处罚。

适值全国律师咨询日，我们梳理了企业经营中高发风险场景，涵盖公司治理、合同履约、财税合规、劳动用工、知产保护，

整理成这份 《企业法律健康体检清单》，供贵司对照自查。

若自查过程中遇到疑问，或是发现存在潜在风险隐患，可通过以下方式对接：

1、直接回复本邮件；

2、扫描下方二维码 / 添加微信 (15810733362)。

我们可为您提供1 次 15‑20 分钟免费线上风险解读，针对您提出的疑点做初步分析，提前排查经营隐患。
...
const SMS_TEMPLATES = {
  1: "【北京觅理律师事务所】{company_name} 您好，企业风控不仅在于诉讼胜诉，更重在源头规避法律风险，减少纠纷损失与合规处罚。适值全国律师咨询日，我所梳理公司治理、合同履约、财税合规、劳动用工、知产保护五维高频风险，整理《企业法律健康体检清单》供自查。如需清单或有诉讼需求可添加微信（同手机号）咨询。退订请回复T",
  2: "",
  3: "",
  4: "",
  5: ""
